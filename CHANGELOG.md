...
- **ADDED**: `mobile/balance-sim.js` optional 2nd CLI argument forces both seats onto a named AI ladder rung for isolated profile testing (e.g., `node mobile/balance-sim.js 10 level-8`); omitting the rung reverts to the default random/adaptive behaviour (see CHANGELOG v2.5.0 for the ladder definition).
